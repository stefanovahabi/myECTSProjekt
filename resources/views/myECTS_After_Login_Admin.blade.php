...
@section('content')
    <div class="row" id="bilderzeile">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
            ...
            <a href="{{ url('/controlpanel') }}"><img src="img/admin.png" alt="Browser kacke" class="img-responsive obereBilder" width="200" height="200"></a>
        </div>
    ...
    <div class="row" id="startseite">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <h1 id="willkommen">Willkommen auf der Startseite, {{{ Auth::user()->email }}} !</h1>
        </div>
    </div>
